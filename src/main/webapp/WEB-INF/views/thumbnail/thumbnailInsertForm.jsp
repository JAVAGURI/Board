		...
		<form action="${ pageContext.servletContext.contextPath }/thumbnail/insert" method="post" encType="multipart/form-data">
			<div class="thumbnail-insert-area">
				...
				<div class="thumbnail-file-area">
					<input type="file" id="thumbnailImg1" name="multiFiles" onchange="loadImg(this,1)" required="required">
					<input type="file" id="thumbnailImg2" name="multiFiles" onchange="loadImg(this,2)" >
					<input type="file" id="thumbnailImg3" name="multiFiles" onchange="loadImg(this,3)" >
					<input type="file" id="thumbnailImg4" name="multiFiles" onchange="loadImg(this,4)" >
				</div>
			</div>
			<br>
