...
<body>
	...
	<div class="outer outer-notice-insert">
		...
		<div class="table-area">
			<form action="${ pageContext.servletContext.contextPath }/notice/update/${ requestScope.notice.no }" method="post">
				<table>
					<tr>
						<td>제목 </td>
					...
					<tr>
						<td>작성자 </td>
						<td>
							<input type="text" value="${ requestScope.notice.writer.nickname }" name="nickname" readonly>
						</td>
					</tr>
					<tr>
						<td>내용 </td>
